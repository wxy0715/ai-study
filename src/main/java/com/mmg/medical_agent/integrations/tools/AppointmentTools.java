package com.mmg.medical_agent.integrations.tools;

import com.mmg.medical_agent.entity.Appointment;
import com.mmg.medical_agent.service.AppointmentService;
...
public class AppointmentTools {
    ...
    @Tool(name = "bookAppointment", value = "根据参数，先执行工具方法queryDepartment查询是否可预约，并直 接给用户回答是否可预约，并让用户确认所有预约信息，用户确认后再进行预约。如果用户没有提供具体的医生姓名，请从向量存储中找到一位医生。")
